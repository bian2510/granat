...
RSpec.describe "property_features/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit property_feature form" do
    render

    assert_select "form[action=?][method=?]", property_feature_path(@property_feature), "post" do
